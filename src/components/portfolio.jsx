          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">These are my recent projects.</p>
          ...
          <div className="row">
            ...
            <div className="col-md-6 ">
              <div className="work-box">
                ...
                <div className="container">
                  <span className="detail">
                    We Protect You is a charitable web application developed to
                    support indigent. The platform allows indigent, donors, and
                    NGOs to register. Indigent can post their specific
                    requirements, such as groceries, money, or medicines, based
                    on predefined categories. Donors and NGOs can then provide
                    the necessary assistance. The administrator reviews and
                    approves posts to ensure their validity. Additionally, NGOs
                    can contact donors to request support for their charitable
                    activities.
                  </span>
                </div>
                <a
